...
def parse_args(args=None):
    ...
    parser.add_argument('--embedding-norm-prefill', action='store_true', help="Whether to use base embedding-norm prefill pruning")
    parser.add_argument('--limit', type=int, default=None, help="Evaluate only the first K samples per dataset.")
    ...
    assert sum([args.spec_prefill, args.embedding_norm_prefill, args.llm_lingua, args.minference]) <= 1, \
...
if __name__ == "__main__":
    ...
    if args.embedding_norm_prefill:
        sys.path.append("../../")
    ...
    if not args.spec_prefill and not args.embedding_norm_prefill:
